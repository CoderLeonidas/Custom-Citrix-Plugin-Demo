...
typedef enum _VDINFOCLASS {
	...
	VdUserNotificationActivated = 57,		// Notify drivers that a user notification was activated

    VdImeSendTextToVDA = 59,                          // Set: Tell CTXIME to send text to VDA side
    VdImeSetCTXIMEFeatureToggleStatus = 60,           // Set: Tell CTXIME to set the CTXIME toggle status
} VDINFOCLASS;
