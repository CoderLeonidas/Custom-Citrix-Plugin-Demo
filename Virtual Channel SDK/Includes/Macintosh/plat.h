...
typedef enum _HDXOverUDP
{
	HDXOverUDP_Off,         // use TCP
	HDXOverUDP_On,          // use UDP and don't fall-back to TCP on failure
	HDXOverUDP_Preferred    // try UDP first and fall-back to TCP on failure
} HDXOverUDP;
