 ...
 */
UINT _VPAPI Mem_alloc(HND poolId, ULONG size, PVOID *ppBuffer);
UINT _VPAPI Mem_realloc(HND poolId, ULONG size, PVOID *ppBuffer);
UINT _VPAPI Mem_free(HND poolId, PVOID pBuffer);
UINT _VPAPI Mem_allocZeroed(HND poolId, ULONG size, PVOID *ppBuffer);
