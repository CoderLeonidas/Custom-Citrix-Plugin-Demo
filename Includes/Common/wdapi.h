...
typedef struct _ZLSCANCODEUNREGISTERHOOKINFORMATION
{
    ...
    IBOOL                fError;             /*(OUT)Used to indicate success of unregistration, TRUE == ERROR, FALSE == SUCCESS*/
...
typedef struct _ZLUNREGISTERUNICODEHOOKINFORMATION
{
    ...
    IBOOL                fError;         /*(OUT) TRUE == Hook unregistered successfully, FALSE == Hook unregistered unsuccessfully*/
