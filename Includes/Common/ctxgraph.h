...
VPSTATUS Bitmap_createFromGIF (PFNSOURCEFILLBUFFER pfnSourceFillBuffer,
							   PVOID pContext, PGRAPH_BITMAPINFO pBitmapInfo, 
							   PBYTE* ppBitmapBits, PUINT32 pBitmapBitSize);

VPSTATUS Bitmap_queryGIFInformation (PFNSOURCEFILLBUFFER pfnSourceFillBuffer,
									 PVOID pContext, PGRAPH_BITMAPINFO pBitmapInfo, PUINT32 pDecompressedByteCount);
...
VPSTATUS Cursor_create (INT32 xHotSpot, INT32 yHotSpot, PVOID pFaceData, PGRAPH_BITMAPINFO pFaceInfo,
						PVOID pMaskData, PGRAPH_BITMAPINFO pMaskInfo, BOOLEAN fMonochrome, HGDC hgDC, PHGCURSOR phCursor);
